...
//  this is how we do dynamic routing in next js 
     ...
     <div className='w-full md:py-20 relative'>
      <Wrapper>
        ...
        {/* pagination start */}
          ...
          {isLoading && (
              <div className="absolute   md:top-[45px]  left-0 w-full h-full bg-white/[0.5] flex flex-col gap-5 justify-center items-center">
...
//  get  static paths requires using get static props
